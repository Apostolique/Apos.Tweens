    ...
    public class GameRoot : Game {
        ...
        protected override void LoadContent() {
            ...
            _tweens = new ITween<Vector2>[] {
                ...
                CreateTween(ref top, left, right, duration, wait, Easing.QuartIn),
                ...
                CreateTween(ref top, left, right, duration, wait, Easing.QuartInOut),
                ...
                CreateTween(ref top, left, right, duration, wait, Easing.QuartOut),
